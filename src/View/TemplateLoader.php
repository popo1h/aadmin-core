...
class TemplateLoader implements Twig_LoaderInterface, Twig_ExistsLoaderInterface, Twig_SourceContextLoaderInterface
{
    ...
    /**
     * @param string $rootPath The root path common to all relative paths (null for getcwd())
     */
    ...
    private function parseName($name, $default = null)
    {
        if (!isset($default)) {
            $default = $this->mainNamespace;
        }
